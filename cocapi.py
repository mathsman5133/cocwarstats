...
class ApiCall(object):
    ...
    def __init__(self, bearer_token, endpoint, api_version,
        ...
        # self._session = aiohttp.ClientSession(loop=self.loop, connector=aiohttp.BaseConnector())
    ...
    async def _process_call(self, method):
        ...
        async with aiohttp.request(method, url, headers=self.build_headers()) as r:
